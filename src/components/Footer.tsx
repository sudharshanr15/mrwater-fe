...
export default function Footer(): React.ReactElement {
  return (
    <footer className="bg-[var(--color-primary-60)] text-white">
      <div className="container-wrapper px-5 md:px-10 lg:px-12 py-12 sm:py-16 lg:py-24">
        {/* Top area */}
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24 xl:gap-32 lg:flex lg:flex-row lg:justify-between">
          ...
          <div className="lg:flex-1 lg:max-w-[60%] xl:max-w-[55%]">
            <h2 className="text-4xl md:text-5xl lg:text-[var(--text-heading-1)] font-extrabold leading-tight">
              Let&apos;s bring your
              <br />
              Idea to life!
            </h2>
          ...
          <div className="text-white/90 lg:max-w-[35%] xl:max-w-[40%]">
            <div>
              <p className="text-[var(--text-body-xs)] font-semibold text-white/80">Office Location</p>
              <p className="mt-2 max-w-md text-[var(--text-body-xl)] leading-relaxed">
            ...
            <div className="mt-8">
              <p className="text-[var(--text-body-xs)] font-semibold text-white/80">Contact</p>
              <p className="mt-2 text-[var(--text-body-xl)] leading-relaxed">
                support@mrwater.com
                <br />
                +91 98765 433210
              </p>
        ...
        <div className="text-center">
          <h3 className="text-[var(--text-heading-3)] font-semibold">Useful Links</h3>

          <nav className="mt-6 flex flex-wrap items-center justify-center text-white/90">
            {footerLinks.map((link, index) => (
              <React.Fragment key={link.label}>
                <a
                  className="px-3 py-2 text-[var(--text-body-base)] hover:text-white"
                  href={link.href}
                >
                  {link.label}
                </a>
          ...
          {/* Copyright */}
          <p className="mt-6 text-[var(--text-body-xs)] text-white/70">
